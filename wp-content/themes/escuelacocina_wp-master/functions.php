...
function edc_scripts() {
     ...
     wp_enqueue_style( 'poppins', 'https://fonts.googleapis.com/css?family=Poppins:300,400,500,600&display=swap', array(), 'all');
     wp_enqueue_style( 'ubuntu', 'href="https://fonts.googleapis.com/css?family=Ubuntu:300,400&display=swap', array(), 'all');
     /** Scripts */
